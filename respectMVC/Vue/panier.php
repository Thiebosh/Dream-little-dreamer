			...
			<table>
				...
				<?php foreach($_SESSION['panier'] as $produitCommande) { ?>
					<tr>
						...
						<td>
							<a href="index.php?action=produit&ref=<?= htmlspecialchars($produitCommande['id_produit']) ?>">
						...
						<td>
							<form method="post" action="index.php?action=panier">
								...
								<input class="supprimerArticle" type="image" src="Vue/images/annule.jpg" width="20">
							</form>
						</td>
					</tr>
				<?php } ?>
