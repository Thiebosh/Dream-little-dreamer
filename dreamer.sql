...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  ven. 12 oct. 2018 à 14:31
...
(1, 'Lampes', 'Lampe de chevet enfant', 'Toute mignonne, cette lampe à poser éclairera doucement la chambre de votre enfant tout en la décorant délicatement.', 20, 20),
(2, 'Lampes', 'Plafonnier Mapple', 'Cette lampe fait apparaitre une véritable forêt de feuilles et assure incontestablement un éclairage chalheureux. ', 120, 40),
(3, 'Bougies', 'Bougie ananas rose', 'Bougie de cire contenue dans une boîte en porcelaine en forme d\'ananas avec couvercle. ', 200, 5),
(4, 'Bougies', 'Lot de 3 bougies led horizon doré', 'Pratiques, la flamme ne brûle pas et elles ne s\'éteignent pas au moindre courant d\'air. ', 0, 20);
COMMIT;
